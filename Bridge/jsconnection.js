...
var JSconnection = $hxClasses["JSconnection"] = function() {
	this.cnx = null;
	new js.JQuery(js.Lib.document).ready($bind(this,this.init));
};
...
JSconnection.prototype = {
	...
	,init: function(e) {
		...
		this.cnx = haxe.remoting.ExternalConnection.flashConnect("default","MyFlash",ctx);
		haxe.Timer.delay($bind(this,this.run),1000);
	}
	,cnx: null
