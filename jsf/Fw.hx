...
Refer to the Fireworks object by using public function propertyName or fireworks.propertyName. Note that fireworks must be lowercase.
*/

 /*generated by postite with theese filters
// javascript:void(function(){

// $($(".tablenoborder tr td:first-of-type .codeph").each(function(index,node){var nom=$(node).text();var type=$(node).parents("td").first().next("td").find("p").text();var defaut=$(node).parents("td").first().next("td").next("td").find("p").text();console.log("var "+nom+":"+type+ "; "+ "/* "+defaut+"")}) );
...
predecessor/successor is 100*public function ellipseBCPConst pixels
...
public function browseForFolderURL(?title:String,?startFolder:String):Void;

public function browseHelp(helpID:Int):Void;//Opens the specified help topic in the help viewer.
...
public function chooseScriptTargetDialog(formatlist:Dynamic):Array<String>;
...
public function createDocumentWithDialog():Document;
...
public function createFireworksDocument(size:{x:Float,y:Float}, res:Resolution_data_type, backgroundColor:HexColor):Document;
// Description
...
public function dismissBatchDialogWhenDone(autoClose:Bool):Void;

// Turns on debugging messages for Flash commands. When Flash debugging is enabled, Fireworks displays the command string in a dialog box every time a Flash command calls MMExecute(). The fw.enableFlashDebugging() function is particularly useful for monitoring which commands are executed in a command panel. For information on how to turn off Flash debugging, see fw.disableFlashDebugging(). For more information about constructing Flash command panels for Fireworks, see Flash panels.

// Note: This debugging command works even if you are running a JavaScript file.
public function enableFlashDebugging():Void;
...
public function exportAndCopyHTMLCode(document:Document):Bool;
...
public function exportCSSLayers(doc:Document, mode:Int, htmlURL:String, imagesURL:String, trim:Bool):Bool;
...
public function exportDirectorAsLayers(doc:Document,fileURL:String):Bool;
...
public function exportDirectorAsSlices(doc:Document,fileURL:String):Bool;
...
public function exportDocumentAs(document:Document, fileURL:String, exportOptions:ExportOptions):Bool;
...
public function exportFrames(doc:Document,directoryURL:String):Bool;
// Arguments
...
public function exportFXG(doc:Document,pages:String,fileUrl:String):Bool;
...
public function exportHtmlAndImages(doc:Document, htmlUrl:String, imagesUrl:String):Bool;
...
public function exportIllustrator(doc:Document,fileURL:String):Bool;
...
public function exportLayers(docObject:Document, directoryURL:String):Bool;
...
public function exportMXMLAndImages(doc:Document, htmlUrl:String, imagesUr:String):Bool;
...
public function exportPages(doc:Document,images:String,selection:String,fileURL:String):Void;
...
public function exportPDF(doc:Document,pdfURL:String):Bool;
...
public function exportPSD(doc:Document, PSDDocumentURL:String):Bool;
...
public function exportSWF(doc:Document,FlashDocumentURL:String):Bool;
// Arguments
...
public function findApp(macOrWin:String):String;
...
public function findOpenDocument(docName:String):Null<Document>;
...
public function getBlue():HexColor;
// Arguments
...
public function getDocumentDOM().combineCompoundShape
public function getDocumentDOM().createCompoundShape
public function getDocumentDOM().InsertPageForImport
public function getDocumentDOM().VectorOperation
*/
...
public function getDocumentPath(doc:Document):String;

//fuckit
public function getFamilyNameForPSFont(font:String):String;
...
public function getFloaterGroupings():Array<Array<String>>;
...
public function getFloaterPosition(panelName:String):jsf.Rectangle;
//@see getFloaterPosition for valuable argument
public function getFloaterVisibility(panelName:String):Bool;
//@see getBlue
public function getGreen():HexColor;
//Returns the hidden or visible status of the panels.
public function getHideAllFloaters():Bool;
//Returns an HTML file.
public function getHTMLFileForScript():String;
/*Arguments
...
public function getNumberOfTables(filename:String):Int;
//Returns the platform name of the PostScript font.
public function getPlatformNameForPSFont(psFontName:String):String;

//Returns the Preference value (string or numeric) that is associated with the specified Preference key.
public function getPref(prefKey:String):Dynamic;
//@see getBlue 
public function getRed():HexColor;
//Returns the style name of the PostScript font.
public function getStyleNameForPSFont(font:String):String;
...
public function internalNameToUIName(internalName:String):String;
...
public function launchApp(appFile:String):Bool;
/*Arguments
...
public function makeRGBColor(red:Int,green:Int,blue:Int):Dynamic;//don't know the type >Dynamic
//Moves the keyboard focus to the document window.
public function moveFocusToDoc():Void;
/*Arguments
...
public function newDocumentFromTemplate(arg1:String):Void;
/*Usage
...
public function newMobileDocument(arg1:String,arg2:Float,arg3:Float,arg4:Float):Void;
/*Arguments
...
public function openMultiDocument():Void;
...
public function popupColorPicker(screenLoc:jsf.Point, initialColor:HexColor, allowTransparent:Bool, forceWeb216:Bool):HexColor;

//Opens the color pop-up window at the current mouse location to let the user select a color
public function popupColorPickerOverMouse(initialColor:HexColor, allowTransparent:Bool, forceWeb216:Bool):HexColor;

public function previewInDeviceCentral():Void;
...
public function replaceAll():Int;
...
public function revertDocument(doc:jsf.Document):Void;
...
public function runScript(filename:String):Dynamic;
...
public function saveDocumentAsTemplate(doc:jsf.Document,arg2:String):Void;


//Works the same as fw.saveDocumentAsTemplate() except for the async mode of save operation.
public function saveDocumentAsTemplateAsync(arg1:jsf.Document,arg2:String):Void;
...
public function setActiveViewScale(scale:Float,center:Point):Void;
...
public function setFloaterGrouping(panelNameToMove:String, panelNameToReceive:String):Void;
...
public function setFloaterPosition(panelName:String, boundingRectangle:jsf.Rectangle):Void;
...
public function setFloaterVisibility(panelName:String, bVisible:Bool):Void;

//Shows or hides the panels. This behavior is the same as the Tab key behavior.
public function setHideAllFloaters(bHide:Bool):Void;
...
public function setPref(prefname:String, prefval:String):Void;

//Sets up a search.
public function setUpFindReplace(findSpec:jsf.core.Find):Void;
/*Arguments
panelName Acceptable values are "find", "project log", "object", "info", "url", "effect", "history", "mixer", "fill", "stroke", "swatches", "layers", "frames", "behaviors", "optimize", "library", "styles", "optimized colors", "options", and "toolbox".
Note: Any panels not specified in the list of valid arguments (like those in the Command Panels folder which are “outside” the Fireworks application) should be named exactly as they appear in the file system without their file extension. For example, the valid argument name for the Align panel (Align.swf) is "Align", and a valid name for a custom panel file mypanel.swf would be "mypanel".
Returns
...
public function toggleFloater(panelName:String):Void;
...
public function ungroupPrimitives():Void;
...
public function updateHTML(doc:jsf.Document, htmlUrl:String, bRecoverFromError:Bool):Bool;
...
public function writePanelStateToFile(filepath:String):Void;
...
public function yesNoDialog(promptString:String):Bool;
